...
protected:
    virtual IFxProcessorPtr createMasterFx(const AudioFxParams& fxParams,
    ...
    virtual void removeTrackFx(const TrackId trackId, const AudioResourceId& resoureId,
                               AudioFxChainOrder order);
...
private:
    ...
    void fxChainToRemove(const AudioFxChain& currentFxChain, const AudioFxChain& newFxChain,
                         AudioFxChain& resultChain);
    void fxChainToCreate(const AudioFxChain& currentFxChain, const AudioFxChain& newFxChain,
                         AudioFxChain& resultChain);
