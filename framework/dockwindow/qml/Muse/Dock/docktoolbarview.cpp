...
class DockToolBarView::DraggableArea : public KDDockWidgets::QWidgetAdapter,
...
public:
    ...
    std::unique_ptr<KDDockWidgets::WindowBeingDragged> makeWindow() override
    {
        ...
        if (floatingWindow) {
            return std::unique_ptr<KDDockWidgets::WindowBeingDragged>(new KDDockWidgets::WindowBeingDragged(
                                                                          m_ctx, floatingWindow,
                                                                          this));
        }
