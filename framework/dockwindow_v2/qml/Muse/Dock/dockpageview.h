...
class DockPageView : public QQuickItem, public muse::Contextable
{
    ...
    Q_PROPERTY(
        QQmlListProperty<muse::dock::DockToolBarView> mainToolBars READ mainToolBarsProperty CONSTANT)
    ...
    Q_PROPERTY(
        QQmlListProperty<muse::dock::DockingHolderView> panelsDockingHolders READ panelsDockingHoldersProperty)
    Q_PROPERTY(
        muse::dock::DockCentralView
        * centralDock READ centralDock WRITE setCentralDock NOTIFY centralDockChanged)
    Q_PROPERTY(
        muse::dock::DockStatusBar
        * statusBar READ statusBar WRITE setStatusBar NOTIFY statusBarChanged)
