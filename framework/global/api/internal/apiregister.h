...
public:
    ...
    std::pair<ApiObject*, bool /*is need delete*/> createApi(const std::string& api,
                                                             IApiEngine* e) const override;

    void regEnum(const char* uri, const char* name, const QMetaEnum& meta, EnumType type) override;

    void regGlobalEnum(const std::string& module, const QMetaEnum& meta,
                       EnumType type = EnumType::String, const std::string& name = "") override;
