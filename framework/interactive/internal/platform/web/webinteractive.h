...
public:
    ...
    muse::async::Promise<Result> question(const std::string& contentTitle, const Text& text,
    ...
    // files
    muse::async::Promise<muse::io::path_t> selectOpeningFile(const std::string& title,
    ...
    // dirs
    muse::io::path_t selectDirectory(const std::string& title,
                                     const muse::io::path_t& dir) override;
    muse::io::paths_t selectMultipleDirectories(const std::string& title,
                                                const muse::io::path_t& dir,
                                                const muse::io::paths_t& selectedDirectories)
    override;
