...
public:
    ...
    MOCK_METHOD(Result, questionSync,
    ...
    MOCK_METHOD(Result, infoSync,
                (const std::string&, const Text&, const ButtonDatas&, int, const Options&,
                 const std::string&), (override));
    MOCK_METHOD(async::Promise<Result>, info,
                (const std::string&, const Text&, const ButtonDatas&, int, const Options&,
                 const std::string&), (override));

    MOCK_METHOD(Result, warningSync,
                (const std::string&, const Text&, const ButtonDatas&, int, const Options&,
                 const std::string&), (override));
    ...
    MOCK_METHOD(async::Promise<io::path_t>, selectOpeningFile,
                (const std::string& title, const io::path_t& dir,
                 const std::vector<std::string>&
                 filter), (override));
    MOCK_METHOD(io::path_t, selectOpeningFileSync,
                (const std::string&, const io::path_t&, const std::vector<std::string>&, const int),
                (override));
    MOCK_METHOD(io::paths_t, selectOpeningFilesSync,
                (const std::string&, const io::path_t&, const std::vector<std::string>&, const int),
                (override));
    ...
    MOCK_METHOD(io::paths_t, selectMultipleDirectories,
                (const std::string&, const io::path_t&, const io::paths_t&), (override));

    MOCK_METHOD(async::Promise<Color>, selectColor, (const Color&, const std::string&, bool),
                (override));
