...
private:
    ...
    QStringList languagesToUpdate(const QString& mainLanguageCode,
    ...
    void  doUpdateLanguage(const QString& languageCode, std::function<void(int64_t current,
                                                                           int64_t total,
                                                                           const std::string&)> progressCallback, std::function<void(const Ret&)> finished);
