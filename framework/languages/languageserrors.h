...
inline Ret make_ret(Err e)
{
    ...
    case Err::ErrorDownloadLanguage: return Ret(retCode,
                                                muse::trc("languages",
                                                          "Error while downloading language"));
    case Err::ErrorWriteLanguage: return Ret(retCode,
                                             muse::trc("languages",
                                                       "Error while writing language files"));
    case Err::ErrorLanguageNotFound: return Ret(retCode, muse::trc("languages",
                                                                   "Language not found"));
