...
public:
    ...
    bool loadLib(const io::path_t& avUtilPath, const io::path_t& avCodecPath,
                 const io::path_t& avFormatPath, const io::path_t& swScalePath,
    ...
    int (*av_image_fill_arrays)(uint8_t* dst_data[4], int dst_linesize[4], const uint8_t* src,
                                AVPixelFormat pix_fmt, int width, int height, int align) = nullptr;
    int (*av_image_get_buffer_size)(AVPixelFormat pix_fmt, int width, int height,
                                    int align) = nullptr;
    ...
    AVIOContext*(*avio_alloc_context)(unsigned char* buffer, int buffer_size, int write_flag,
                                      ...
                                      int (*write_packet)(void* opaque, const uint8_t* buf,
                                                          int buf_size),
