...
namespace muse::mi {
class MultiProcessProvider : public IMultiWindowsProvider, public IMultiProcessProvider,
    public Contextable, public actions::Actionable, public async::Asyncable
{
