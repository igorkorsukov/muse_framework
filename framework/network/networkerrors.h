...
inline Ret make_ret(Err e)
{
    ...
    case Err::Timeout: return Ret(retCode,
                                  muse::trc("network",
                                            "The connection to the remote server timed out"));
    case Err::NetworkError: return Ret(retCode,
                                       muse::trc("network",
                                                 "An unknown network-related error occurred"));
    case Err::FiledOpenIODeviceRead: return Ret(retCode,
                                                muse::trc("network",
                                                          "The I/O device was not opened for reading"));
    case Err::FiledOpenIODeviceWrite: return Ret(retCode,
                                                 muse::trc("network",
                                                           "The I/O device was not opened for writing"));
    }
