...
public:
    ...
    struct Index
    {
        ...
        inline bool operator ==(const Index& idx) const
        {
            return column == idx.column && row == idx.row;
        }
...
public:
    ...
    virtual void requestActive(INavigationControl* control = nullptr, bool enableHighlight = false,
                               INavigation::ActivationType activationType = INavigation::ActivationType::None)
    = 0;
};
...
public:
    ...
    virtual void requestActive(INavigationPanel* panel = nullptr,
                               INavigationControl* control = nullptr, bool enableHighlight = false,
                               INavigation::ActivationType activationType = INavigation::ActivationType::None)
    = 0;
};
}
