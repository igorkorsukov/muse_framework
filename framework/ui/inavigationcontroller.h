...
public:
    ...
    virtual const INavigationPanel* findPanel(const std::string& sectionName,
                                              const std::string& panelName) const = 0;
    virtual const INavigationControl* findControl(const std::string& sectionName,
