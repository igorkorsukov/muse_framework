...
public:
    ...
    const INavigationPanel* findPanel(const std::string& sectionName,
                                      const std::string& panelName) const override;
    const INavigationControl* findControl(const std::string& sectionName,
...
private:
    ...
    void onActiveRequested(INavigationSection* sect, INavigationPanel* panel,
                           INavigationControl* ctrl, bool force = false);
