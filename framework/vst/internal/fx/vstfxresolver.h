...
private:
    ...
    audio::IFxProcessorPtr createTrackFx(const audio::TrackId trackId,
                                         const audio::AudioFxParams& fxParams,
                                         const audio::OutputSpec& outputSpec) const override;

    void removeMasterFx(const audio::AudioResourceId& resoureId,
